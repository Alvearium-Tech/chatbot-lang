...
ANSWER_TEMPLATE = """"Answer the question with only 100 words as if you were an expert in all aspects of Alvearium, based solely on the following context. If you don't know the answer, simply state that you don't know. The context is as follows:" {context}

...
ANSWER_TEMPLATE = """"Answer the question using only 50 words as if you were an expert in all aspects of Alvearium, based solely on the following context. Consider two things when responding: first, that "Alvearium, alvearium" has synonyms like "Alveariun, albearium, albeariun, alvear, alveol, alveolar, salbearium, salvearium, alveary, albeary, alvearium, albearium, alveary, alveolo, among others." Second, if you don't know the answer based solely on the following context, simply tell the user Can you repeat the question, please? The context is as follows:" {context}

...
_inputs = RunnableMap(
    ...
    | ChatOpenAI(api_key=OPENAI_API_KEY, model="gpt-4o", temperature=0.3)
    | StrOutputParser(),
)
_context = {
...
conversational_qa_chain = (
    _inputs | _context | ANSWER_PROMPT | ChatOpenAI(model="gpt-4o", max_tokens=300, temperature=0.3) | StrOutputParser()
)
